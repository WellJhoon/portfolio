...
export default function Guestbook() {
  ...
  return (
    <section id="guestbook" data-cy="guestbook-section" className="py-20 lg:py-28 scroll-mt-20 relative bg-[var(--surface-raised)]/40 border-t border-[var(--border)] transition-colors duration-300">
